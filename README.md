...
CS 5v5 是一款使用 Godot 4.6 开发的低模 3D 第一人称单人枪战游戏。玩家加入蓝队，与 4 名队友 AI 对战 5 名橙队 AI；每局 5 分钟，一方全灭提前结算，时间到按存活人数判胜。
...
- 地图选择：11 张原创程序化低模地图，前 3 张免费，其余按 `6/10/10/12/12/15/15/18` 星递增解锁。
- 难度：简单、普通、困难三档 AI。
